 ...
 * @author Amine
 */
public class TriangleWaveInventoryIcon extends InventoryIcon{
    WaveSuperpositionModule module;
    public TriangleWaveInventoryIcon (Core creator, WaveSuperpositionModule module) {
        super("triangle wave",creator);
        display.setImage(new Image(new File("src/Assets/TriangleWaveInventoryIcon.png").toURI().toString()));
        this.module = module;
    }
    @Override
    public void action(){
        Stage window = generateTriangularCurveWindow();
        window.show();
    }
    public Stage generateTriangularCurveWindow() {
