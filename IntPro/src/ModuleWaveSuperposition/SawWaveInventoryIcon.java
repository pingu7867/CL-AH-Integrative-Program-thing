 ...
 * @author Amine
 */
public class SawWaveInventoryIcon extends InventoryIcon{
    WaveSuperpositionModule module;
    public SawWaveInventoryIcon(Core creator, WaveSuperpositionModule module) {
        super("saw wave",creator);
        display.setImage(new Image(new File("src/Assets/SawWaveInventoryIcon.png").toURI().toString()));
        this.module = module;
    }
    @Override
    public void action(){
        Stage window = generateSawtoothCurveWindow();
        window.show();
    }
    public Stage generateSawtoothCurveWindow() {
